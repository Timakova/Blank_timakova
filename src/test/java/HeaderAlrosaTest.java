...
public class HeaderAlrosaTest {
    ...
    //Тесты
    @Test
    @Link(name = "Ссылка на главную страницу", url = "https://diamonds.alrosa.ru/") //Добавление в allure ссылки на нужную страницу
    @Severity(SeverityLevel.MINOR) //Критичность тест-сценария для отображении в allure (BLOCKER, CRITICAL,MINOR, NORMAL, TRIVIAL)
    @DisplayName("Проверка перехода юридическим лицам") //Название тест-сценария в allure
    @Owner(value = "Тимакова Т.В.") //Инициалы того, кто написал тест-сценарий
    public void HeaderAlrosaTest() {
        headerAlrosa.сlickHeaderB2C();
